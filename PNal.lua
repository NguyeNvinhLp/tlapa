...
Weapon:Seperator(" Mirage Island ")

Weapon:Toggle("Auto Mirage Island",false,function(value)
 if game:GetService("Workspace").Map:FindFirstChild("MysticIsland") then
                           topos(game:GetService("Workspace").Map:FindFirstChild("MysticIsland").HumanoidRootPart.CFrame * CFrame.new(0,500,-100))
                    else
if _G.Mystichop then
...
Weapon:Toggle("Auto Mirage Island Hop",false,function(value)
 _G.Mystichop = value
end)
...
game.StarterGui:SetCore("SendNotification", {
        Title = "Snow X hub"; -- Notify check mirage
        Text = "Mirage not Spawn!"; -- what the text says (ofc)
        Icon = "rbxassetid://12855499169"; -- the image if u want. 
